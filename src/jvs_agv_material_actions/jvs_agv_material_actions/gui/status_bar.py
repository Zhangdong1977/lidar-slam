...
class StatusBar(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._conn_label.setStyleSheet('font-weight: bold; color: orange;')
        layout.addWidget(self._conn_label)

        layout.addSpacing(20)

        self._phase_label = QtWidgets.QLabel('阶段: IDLE')
        self._phase_label.setStyleSheet('font-weight: bold;')
    ...
    def set_connected(self, connected: bool):
        if connected:
            ...
            self._conn_label.setStyleSheet('font-weight: bold; color: green;')
        else:
            self._conn_label.setText('连接: 断开')
            self._conn_label.setStyleSheet('font-weight: bold; color: red;')
