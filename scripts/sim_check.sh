...
check "机器人模型"               "test -f /home/pi/Desktop/code/lidar-slam/models/sim_robot/model.sdf"
check "测试世界"                 "test -f /home/pi/Desktop/code/lidar-slam/worlds/slam_test.sdf"
check "SLAM 配置"               "test -f /home/pi/Desktop/code/lidar-slam/config/slam_toolbox_sim.yaml"
check "Launch 文件"             "test -f /home/pi/Desktop/code/lidar-slam/launch/sim_slam.launch.py"
